...
function mostrarHTML(fotos) {
    ...
    fotos.forEach(fotos => {
        ...
        foto.addEventListener('click', () => {
            ...
            fotoFull = fotos.url
            fotoId = fotos.id
            fotoFotografo = fotos.fotografia
            console.log(fotoFotografo)
            verificarTamanho();
...
function fullSizeFoto() {
    ...
    // info.href = 'https://juanvelezphoto.com';
    // info.target = '_blank';
    // info.className = 'autorFoto';
    // info.textContent = `Fotografía Juan Vélez`;
    ...
    cerrarImagen.src = '../../pictures/dresses/cerrar.png';
    cerrarImagen.classList.add('cerrarFullSize');
    
    nextImage.src = '../../pictures/dresses/right-chevron.png';
    nextImage.classList.add('nextImage');
    
    previousImage.src = '../../pictures/dresses/left-chevron.png';
